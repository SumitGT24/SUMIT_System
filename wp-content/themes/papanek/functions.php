...
function papanek_setup_notice() {
    ...
    if ( ! $is_dismissed ) {
        ...
        <h3>'.__('Hi, I\'m Roman Fink, the developer of the Papanek theme. I hope this theme helps you build your great website','papanek').' 😉</h3>
        ...
        𝕏 '.__('Follow me on X:','papanek').' <a href="https://twitter.com/romanfinkwp">@romanfinkwp</a><br><br>
        <b>'.__('Just close this notice to hide it. All the best!','papanek').'</b></div>';
