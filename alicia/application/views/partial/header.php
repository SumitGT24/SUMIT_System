...
<head>
    ...
    <title><?php 
		 ...
		 echo !is_on_demo_host() ?  $company.' - '.' Software de Ventas e Inventarios' : '' ?></title>
				...
				<nav class="navbar navbar-default top-bar">
					...
					<?php } ?>
						...
						<li class="dropdown">
							...
							<li>
									<a tabindex = "-1" id="support_link" target="_blank" href="#"><i class="ion-help-buoy"></i><span class="text"><?php echo lang('common_support'); ?></span></a>									
							</li>
								...
								<li>
									<a tabindex = "-1" id="update_billing_link" target="_blank" href="#"><i class="ion-card"></i><span class="text"><?php echo lang('common_update_billing_info'); ?></span></a>									
								</li>
