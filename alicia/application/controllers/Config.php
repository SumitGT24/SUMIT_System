...
class Config extends Secure_area 
{
	...
	function save()
	{
      ...
      curl_close($ch);		
		...
		#REVISADO'paypal_me' => $this->input->post('paypal_me'),
		...
		#Revisado 100%'customers_store_accounts' => $this->input->post('customers_store_accounts') ? 1 : 0,
		#'show_language_switcher' => $this->input->post('show_language_switcher') ? 1 : 0,
		#REVISADO'return_policy'=>$this->input->post('return_policy'),
		...
		#revisado'number_of_items_in_grid' => $this->input->post('number_of_items_in_grid'),
