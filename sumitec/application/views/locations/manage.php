...
<div class="add-location-link">
	<div class="col-md-12 text-center">
		<?php if (!is_on_demo_host() && !$deleted) { ?>
			<div class="alert alert-info" role="alert"><?php echo lang('locations_adding_location_requires_addtional_license'); ?>: <strong><a href="https://web.whatsapp.com/send?phone=+50237376619" target="_blank"><?php echo lang('locations_purchase_additional_locations'); ?></a></strong></div>
		<?php } ?>
	</div>
</div>
