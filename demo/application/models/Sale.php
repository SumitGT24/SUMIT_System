...
class Sale extends MY_Model
{
	...
	function save($cart)
	{
		...
		$nit = $cart->nit ? $cart->nit : '';
		$nombreCliente = $cart->nombreCliente ? $cart->nombreCliente : '';
		$fell = $cart->fell ? $cart->fell : '';
	...
	public function update_sale_fell($sales_data, $sale_id)
	{
		$this->db->where('sale_id', $sale_id);
		$this->db->set('fell', $sales_data);
