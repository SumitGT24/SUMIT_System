					...
					<div class="panel">
						<div class="panel-body">					
						   <div class="alert alert-success">
						    ...
						    <a class="btn btn-block btn-success" href="https://web.whatsapp.com/send?phone=+50237376619" target="_blank"><?php echo lang('common_update_billing_info');?></a>
							</div>
						</div>
					</div>
			<?php } ?>
				...
				<div class="col-md-12">
					<div class="panel">
						<div class="panel-body">
							...
							<a class="btn btn-block btn-sm btn-success" href="https://web.whatsapp.com/send?phone=+50237376619" target="_blank"><?php echo lang('login_resignup');?></a>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="panel">
				<div class="panel-body">
					...
					<div id="reseller_activate_container">
						...
						<h3>      <a href="https://web.whatsapp.com/send?phone=+50237376619" target="_blank">Adquirir Software de Ventas</a> </span> 
</h3>
						<p><?php echo lang('home_reseller_program_signup')?></p>
						<a href="https://web.whatsapp.com/send?phone=+50237376619" class="reseller_description btn btn-primary" target="_blank">
		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-body">
					...
					<div id="reseller_activate_container">
						<h3><a href="https://web.whatsapp.com/send?phone=+50237376619" target="_blank"><?php echo lang('home_feedback'); ?></a></h3>
			...
			<div class="panel">
				<div class="panel-body">
					...
					<div id="mercury_activate_container">
						<h3><a href="https://web.whatsapp.com/send?phone=+50237376619" target="_blank"><?php echo lang('common_credit_card_processing'); ?></a></h3>
		...
		<div class="col-md-12">
			<div class="panel">
				<div class="panel-body">
					...
					<div id="reseller_activate_container">
						<h3><a href="https://web.whatsapp.com/send?phone=+50237376619" target="_blank"><?php echo lang('home_bluejay_reviews'); ?></a></h3>
