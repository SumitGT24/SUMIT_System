		...
		if ($this->cart->nit == "") {
			...
			for ($i = 0; $i < count($detalleFEL); $i++) {
				...
				if ($detalleFEL[$i]->allow_alt_description) {
					$descriptionItem = $detalleFEL[$i]->description;
			...
			$xml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" .
				...
				"<TOTALDOC_PIE_PAGINA>EN REPUESTOS ELÉCTRICOS, HERRAMIENTAS Y PRODUCTOS CORTADOS A LA.
				MEDIDA NO HAY CAMBIOS NI DEVOLUCIÓNES. OTROS PRODUCTOS, UN MÁXIMO DE 2 DÍAS PRESENTANDO ESTE DOCUMENTO.
				TODOS LOS PRECIOS YA INCLUYEN IVA Y DESCUENTO.</TOTALDOC_PIE_PAGINA>".
				"</dte:Adenda>".
